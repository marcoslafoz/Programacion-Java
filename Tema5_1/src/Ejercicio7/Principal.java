...
public class Principal {
	public static void main(String[] args) {
		try(Scanner teclado = new Scanner(System.in)){
			...
			switch(select) {
			case 1: //Opcion1
				System.out.println("Longitud con radio ("+ radio +"): "+ longitudCirculo.calcLongitudCirculo(radio)); 
				break;  
			case 2: //Opcion2
				System.out.println("Superficie con radio ("+ radio +"): "+ superficieCirculo.calcSuperficieCirculo(radio)); 
				break;  
			case 3: //Opcion3
				System.out.println("Volumen de una esfera con radio ("+ radio +"): "+  volumenEsfera.calcVolumenEsfera(radio)); 
				break;  
